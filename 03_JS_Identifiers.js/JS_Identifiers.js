...
// Run with:  node JS_Identifiers.js
// ============================================================
...
function scopeDemo() {
  ...
  console.log(inner); // I live inside the function
}
scopeDemo();
...
console.log(blockVar); // I escaped the block
...
console.log(hoisted); // now I have a value
...
console.log(k); // 3  (k still exists outside the loop!)

// ------------------------------------------------------------
// 12. Implicit global (NO `var` keyword) — bad practice
// ------------------------------------------------------------
leaked = "I became global by accident";
console.log(leaked); // I became global by accident
